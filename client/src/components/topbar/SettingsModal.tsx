export default function SettingsModal({ setOpenSettings }: { setOpenSettings: () => void }) {
  return (
    <div
      id="defaultModal"
      tabIndex={-1}
    ...
    >
      <h1 className="text-midnight">Settings</h1>

      <div className="flex flex-col items-center justify-center">
        <button onClick={() => setOpenSettings()}>Leave</button>
      </div>
    </div>
  );
}
