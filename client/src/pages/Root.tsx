...
export default function Root() {
  const { isLogoutModalOpen, toggleLogoutModal, openMenu } = useToggleContext();
  ...
  return (
    <>
      {isLogoutModalOpen && <div className="absolute top-0 left-0 z-50 w-full h-full bg-black/50" />}
      {isLogoutModalOpen && (
